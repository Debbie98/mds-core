...
export interface NoParkingIntentRuleUserFields extends Partial<BaseRule<Partial<MicroMobilityStatesToEvents>>> {
  geographies: UUID[]
  days?: Nullable<DAY_OF_WEEK[]>
  start_time?: Nullable<TIME_FORMAT>
  end_time?: Nullable<TIME_FORMAT>
...
export interface NoParkingIntentUserFields {
  rule_fields: NoParkingIntentRuleUserFields
  policy_fields: BasePolicyIntentUserFields
}

export const NoParkingIntentRuleFixedValues: Partial<BaseRule<Partial<MicroMobilityStatesToEvents>>> = {
...
export function translateTemplateToPolicy(templateFields: any, intent: any) {}
